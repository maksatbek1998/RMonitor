        ...
        public static void MusicPlay(string numSound,string operSound , string Lang)
        {
            try
            {
                if (Lang == "RU")
                {
                    ...
                    SoundPlayer Sound = new SoundPlayer(@"C:\rsk\sound\ru\ЭКГ.wav");
                    Sound.PlaySync();
                    char suffix;
                    suffix = numSound[0];
                    Sound.SoundLocation = @"C:\rsk\sound\ru\" + suffix + ".wav";
                    Sound.PlaySync();
                    ...
                    Sound.SoundLocation = @"C:\rsk\sound\ru\пройдите_в_отдел.wav";
                    Sound.PlaySync();
                ...
                {
                    SoundPlayer Sound = new SoundPlayer(@"C:\rsk\sound\kg\А.wav");
                    Sound.PlaySync();
                    char suffix;
                    suffix = numSound[0];
                    Sound.SoundLocation = @"C:\rsk\sound\kg\" + suffix + ".wav";
                    Sound.PlaySync();
                    numSound = numSound.Substring(1);
                    if (int.Parse(numSound) <= 100)
                    {
                    ...
                    Sound.SoundLocation = @"C:\rsk\sound\kg\ЭКГ.wav";
                    Sound.PlaySync();
                    Sound.SoundLocation = @"C:\rsk\sound\kg\" + operSound + ".wav";
                    Sound.PlaySync();
                    Sound.SoundLocation = @"C:\rsk\sound\kg\РегистрРегистр.wav";
                    Sound.PlaySync();
                }
                else if (Lang == "EN")
                {
                    SoundPlayer Sound = new SoundPlayer(@"C:\rsk\sound\en\A.wav");
                    Sound.PlaySync();
                    char suffix;
                    suffix = numSound[0];
                    Sound.SoundLocation = @"C:\rsk\sound\en\" + suffix + ".wav";
                    Sound.PlaySync();
                    numSound = numSound.Substring(1);
                    if (int.Parse(numSound) <= 100)
                    {
                    ...
                    Sound.SoundLocation = @"C:\rsk\sound\en\Сиздин талон жараксыз.wav";
                    Sound.PlaySync();
